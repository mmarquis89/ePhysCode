function [meanTraces, h] = avg_trace_overlay(bl, figInfo, traceGroups, groupColors, medfilt, offset)
%=========================================================================================================
...
plot_traces(h, bl, figInfo, meanTraces, groupColors, annotLines, annotColors);
