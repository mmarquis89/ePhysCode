...
for iTrial = 1:nTrials
    ...
    if ~isempty(dir(fullfile(parentDir, strDate, trialStr, '*pgm*'))) % Check to make sure is some video for this trial
...
expData = loadExperiment('2017-Mar-22', 2);
...
%% Load next exp.
expData = loadExperiment('2017-Mar-23', 1);
...
%% Load next exp.
expData = loadExperiment('2017-Mar-23', 2);
...
%% Load next exp.
expData = loadExperiment('2017-Mar-23', 3);
